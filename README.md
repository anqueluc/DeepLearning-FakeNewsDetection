...
You also need to <b>download the word embedding file</b> from https://drive.google.com/open?id=14jZwyHLQavuGa0UsaojqUBJsOWY2q2Ht and place the file right in the <b>data</b> folder.

And to <b>download the result folder</b> from https://drive.google.com/open?id=1r_xIUsDIVIbcpQu3RSFvGaz7t6bI1cnE and put the folder <b>results</b> aside the other folders, in order to have the weights of the best model among every trained one, thus being able to re-train one of our models or to train one of yours.
